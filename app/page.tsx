...
export default function Home() {
  ...
  return (
    <Container maxWidth="xl">
      ...
      {/* header subtitles + logo */}
      <FadeIn delay={600}>
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', pb: { xs: 6, md: 6 } }}>
          <Box sx={{ mb: 4 }} component="img" src="/homepage/reach.png" />
          <Typography variant="subtitle1" sx={{ textAlign: 'center', color: '#95A5A6' }}>
      ...
      {/* enquire now */}
      <FadeIn delay={1200}>
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', pb: { md: 8, xs: 5 } }}>
          <Button
      ...
      {/* youtube */}
      <FadeIn delay={1800}>
        <Box sx={{ pb: 6, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <IntroMedia />
        </Box>
      </FadeIn>
          ...
          <AnimateOnScroll delay={600}>
            ...
            >
              ...
              <Box>
                ...
                <Typography variant="body2">
                  Efficient SEO to optimise content visibility, extending your reach and enabling your audience to find you in a cost-effective,
                  sustainable way, naturally and continuously.
                </Typography>
              </Box>
            </Paper>
          </AnimateOnScroll>
      ...
      <Box sx={{ pb: { md: 8, xs: 4 } }}>
        <AnimateOnScroll delay={600}>
          <Box>
            ...
            <Typography color="grey" variant="subtitle1" sx={{ fontWeight: '' }}>
              We partnered with ArabicWithM, a fast-growing TikTok & Instagram creator.<br />
              The account went from <strong>0 to 42,000 followers in 7 months</strong> across Tiktok & Instagram with our tailor-made digital content strategy.
            </Typography>
          </Box>
        </AnimateOnScroll>
      </Box>
                ...
                <Grid size={12}>
                  <AnimateOnScroll delay={600}>
                    ...
                    >
                      ...
                      <Box>
                        <Typography textAlign="center" variant="h2" sx={{ color: '#1976d2', fontWeight: '600' }}>2M+</Typography>
                      </Box>
                    </Paper>
                  </AnimateOnScroll>
                </Grid>
                ...
                <Grid size={12}>
                  <AnimateOnScroll delay={600}>
                    ...
                    >
                      ...
                      <Box>
                        <Typography textAlign="center" variant="h2" sx={{ color: '#1976d2', fontWeight: '600' }}>160k+</Typography>
                      </Box>
                    </Paper>
                  </AnimateOnScroll>
                </Grid>
